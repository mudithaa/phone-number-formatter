...
`;
  ...
  disconnectedCallback() {
    ...
    this.removeEventListener('iron-resize', this._boundSetPosition); // Making sure the dropdown is closed and removed from DOM after detaching the dropdown.
  ...
  _updateValueSlot() {
    ...
    const hasContent = this._hasContent(selected); // Toggle visibility of _valueElement vs fallback input with placeholder


    this._valueElement.slot = hasContent ? 'value' : ''; // Ensure the slot distribution to apply correct style scope for cloned item
  ...
  _setPosition() {
    ...
    this._overlayElement.updateStyles({
      '--vaadin-dropdown-menu-text-field-width': inputRect.width + 'px'
    });
  }
  /**
