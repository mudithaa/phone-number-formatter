  ...
  const klass = (() => class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      if (!this.shadowRoot) {
        ...
        this.shadowRoot.appendChild(document.importNode(styledTemplate.content, true)); // FIXME(platosha): IronFocusablesHelper does only use legacy .root
...
`;
  ...
  disconnectedCallback() {
    super.disconnectedCallback(); // Removing the event listener in case `iron-overlay-canceled` was not fired.
