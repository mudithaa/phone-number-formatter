(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@polymer/polymer/polymer-element.js'), require('google-libphonenumber/dist/libphonenumber'), require('@polymer/iron-input/iron-input.js'), require('@polymer/iron-icon/iron-icon.js'), require('@polymer/polymer/lib/elements/dom-repeat.js'), require('@polymer/polymer/lib/elements/dom-if.js'), require('@vaadin/vaadin-dropdown-menu/vaadin-dropdown-menu.js')) :
  typeof define === 'function' && define.amd ? define(['exports', '@polymer/polymer/polymer-element.js', 'google-libphonenumber/dist/libphonenumber', '@polymer/iron-input/iron-input.js', '@polymer/iron-icon/iron-icon.js', '@polymer/polymer/lib/elements/dom-repeat.js', '@polymer/polymer/lib/elements/dom-if.js', '@vaadin/vaadin-dropdown-menu/vaadin-dropdown-menu.js'], factory) :
  (factory((global.myBundle = {}),global.polymerElement_js));
}(this, (function (exports,polymerElement_js) { 'use strict';
   ...
   */
  class PhoneNumberFormatter extends polymerElement_js.PolymerElement {
    constructor(){
      super();
